    ...
    <Card className="w-full flex flex-col justify-between max-w-sm h-full mx-auto">
      <div>
        <CardHeader className="relative p-0">
          <img src={image} alt="Coupon" className="w-full h-56 object-cover rounded-t-lg" />
          {isSpecial && <Badge className="absolute top-3 right-3">Specjalna oferta</Badge>}
        </CardHeader>
        <CardContent className="p-6 space-y-4">
          <div>
            <CardTitle className="text-xl font-bold mb-2">{offerTitle}</CardTitle>
